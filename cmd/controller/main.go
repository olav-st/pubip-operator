...
import (
	...
	"olav.ninja/pubip-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(pubipv1.AddToScheme(scheme))
...
func main() {
	...
	var fetcherImage string
	var updateInterval time.Duration
	var tlsOpts []func(*tls.Config)
	flag.DurationVar(&updateInterval, "update-interval", 60*time.Minute, "The interval (in minutes) between IP checks")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a10e3eed.olav.ninja",
	...
	if err = (&controller.PublicIPUpdaterReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "PublicIPUpdater")
		os.Exit(1)
	}
